...
Materiały: https://github.com/michbur/WizualizacjaDanych2025-2026L
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/_GpWXtAt55c?si=8g-xPQsWBmnkqL2D" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

# Efektywne projektowanie dashboardów

## Pytania projektowe

1. Co użytkownik chce zrobić za pomocą dashbaordu?
     - wykryć/wyjaśnić/zdecydować?
1. Jaka jest kluczowa akcja użytkownika?
     - odczyt/filtr/drill-down/porównanie/wyszukiwanie
1. Ile czasu użytkownik poświęca na typowe użycie dashboardu?
     - poniżej minuty/5 minut/ponad 5 minut
1. Jaka jest tolerancja opóźnienia w aktualizacji danych?
     - minuta/dzień/miesiąc
...
## Wybór typu dashboardu

```{r}
kable(data.frame(Pytania = c("Co użytkownik chce zrobić za pomocą dashbaordu", 
                       "Jaka jest kluczowa akcja użytkownika?", 
                       "Ile czasu użytkownik poświęca na typowe użycie dashboardu?",
                       "Jaka jest tolerancja opóźnienia?"),
           Operacyjny = c("wykryć", "odczyt/wyszukiwanie", "mniej", "mniejsza"),
           Analityczny = c("wyjaśnić/zdecydować", "filtr/drill-down/porównanie", "więcej", "większa")))
```
...
## Czy warto wykorzystywać interakcję?

Badania wskazują, że interakcja pozwala bardziej zaangażować odbiorców oraz sprzyja retencji informacji.
...
## Główne wyzwania przy wyborze wykresu

1. Hierarchie.
2. Wiele wymiarów w tym samym momencie.
3. Przepływy.
